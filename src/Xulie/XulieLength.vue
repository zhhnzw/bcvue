...
export default {
  ...
  mounted() {
    ...
    this.formInline.no = 'Length' + this.formInline.no
  },
  methods: {
    file1(){
      // window.open('https://www.baidu.com/','_blank')
      window.open(this.Host.BASE_URL + 'public/SequenceProcessing/file_Sequence_length/length.txt','_blank')
    },
    ...
    chartCommit(){
      ...
      if(_this.fileData == null){
        ...
        _this.$axios({
          url: this.Host.BASE_URL  +'SequenceProcessing/file_Sequence_length/multiUpload',
          method: 'post',
          data: _this.formData,
          headers: {
          ...
          if(res.data==='token过期'){
            ...
            _this.$axios({
              url: this.Host.BASE_URL  + 'SequenceProcessing/file_Sequence_length/run',
              method: 'post',
              data: _this.para,
              headers: {
