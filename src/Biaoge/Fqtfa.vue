  ...
  <div class="box">
    <div class="card1">
      ...
      <div id="rightbox">
        ...
        <h2>输入：<br></h2>
        &nbsp;&nbsp;&nbsp;&nbsp;输入的表格文件，支持直接输入FASTQ文件，txt文件等<br>
        <br>
    ...
    <div class="b2">
      <div class="output" v-show="pic!==''">
        <span>文件导出：</span>
        <el-button type="info" icon="el-icon-download" size="mini" :href="csv" @click.prevent="downloadItem(pic, 'fqtfa.txt')" ></el-button>
      </div>
...
export default {
  ...
  mounted() {
    ...
    this.formInline.no = 'fq2fa' + this.formInline.no
  },
  methods: {
    file1(){
      // window.open('https://www.baidu.com/','_blank')
      window.open(this.Host.BASE_URL + 'public/FormatChange/fq2fa/testfq.txt','_blank')
    },
    ...
    chartCommit(){
      ...
      if(_this.fileData == null){
        ...
        _this.$axios({
          url: this.Host.BASE_URL + 'FormatChange/fq2fa/multiUpload',
          method: 'post',
          data: _this.formData,
          headers: {
          ...
          if(res.data==='token过期'){
            ...
            _this.$axios({
              url: this.Host.BASE_URL + 'FormatChange/fq2fa/run',
              method: 'post',
              data: _this.para,
              headers: {
