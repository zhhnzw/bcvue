  ...
  <div class="box">
    <div class="card1">
      ...
      <div id="rightbox">
        ...
        <h2>参数：<br></h2>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.height:自定义输出大小的长度。<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.width:自定义输出大小的宽度。<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.标签阈值：自定义展示气泡的阈值，默认为5，即显示5以上的标签。<br>
        <br>
...
export default {
  ...
  methods: {
    file1(){
      ...
      window.open(this.Host.BASE_URL + 'public/FunctionalAnalysis/goenrich_buttlen/richcircos.txt','_blank')
    },

    file2(){
      // window.open('https://www.baidu.com/','_blank')
      window.open(this.Host.BASE_URL + 'public/FunctionalAnalysis/goenrich_buttlen/gene.txt','_blank')
    },
    ...
    chartCommit(){
      ...
      if(_this.isloadfile>1){
        ...
        if(_this.formInline.size!==''){
          _this.para.size_0 = _this.formInline.size
        }
        if(_this.formInline.ir!==''){
          _this.para.ir_1 =_this.formInline.ir
        }
        if(_this.formInline.or!==''){
          _this.para.or_2 =_this.formInline.or
        }
        ...
        if(_this.fileData == null){
          ...
          _this.$axios({
            url: this.Host.BASE_URL + 'FunctionalAnalysis/goenrich_buttlen/multiUpload',
            method: 'post',
            data: _this.formData,
            headers: {
            ...
            if(res.data==='token过期'){
              ...
              _this.$axios({
                url: this.Host.BASE_URL + 'FunctionalAnalysis/goenrich_buttlen/run',
                method: 'post',
                data: _this.para,
                headers: {
