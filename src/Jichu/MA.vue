<template>
  <div class="box">
    <div class="card1">
      ...
      <div id="rightbox">
        <h2>功能：<br></h2>
        &nbsp;&nbsp;&nbsp;&nbsp;M是组间差异倍数取以2为底的对数值（log2(FC)），A是组间表达量的平均强度，给差异显著（一般为差异倍数为2倍以上，且p值小于0.05）的点不同的颜色，显示两组样品差异显著性。<br>
        <br>

        <h2>输入：<br></h2>
        &nbsp;&nbsp;&nbsp;&nbsp;①输入的表格文件，支持txt(制表符分隔)文本文件。<br>
        &nbsp;&nbsp;&nbsp;&nbsp;②自定义标题，x轴、y轴标题可自行定义，默认标题为"MA Plot",x轴标题为"A",y轴标题为"M"。<br>
        <br>

        <h2>参数：<br></h2>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;①选择两个样本的来源列，后台通过处理得到每个相应的点的位置。<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;②选择Pvalue或Qvalue的列，后台计算后得到标志颜色值<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;③点的大小<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;④X轴标题<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;⑤Y轴标题<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;⑥三种类别不同的颜色<br>
...
export default {
  ...
  methods: {
    file1(){
      ...
      window.open(this.Host.BASE_URL + 'public/BaseFunction/maplot/MA_exa.txt','_blank')
    },
