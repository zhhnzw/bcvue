  ...
  <div class="box">
    <div class="card1">
      ...
      <div id="rightbox">
        ...
        <h2>输入：<br></h2>
        &nbsp;&nbsp;&nbsp;&nbsp;文件支持txt(制表符分隔)文本文件格式。<br>
        &nbsp;&nbsp;&nbsp;&nbsp;数据与数据之间务必用制表符(tab符)隔开，不能用空格，制图时将以第一行做为表头数据。<br>
        <br>
...
export default {
  ...
  methods: {
    file1(){
      ...
      window.open(this.Host.BASE_URL + 'public/BaseFunction/vn_plot/vn_text_5set.txt','_blank')
    },
