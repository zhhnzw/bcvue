<template>
  <div class="box">
    <div class="card1">
      ...
      <div id="rightbox">
        <h2>功能：<br></h2>
        &nbsp;&nbsp;&nbsp;&nbsp;用一个带有表头的表格数据绘制一个动态的散点图。<br>
        <br>

        <h2>输入：<br></h2>
        &nbsp;&nbsp;&nbsp;&nbsp;文件格式说明：数据与数据之间务必用制表符隔开(tab符)，不能用空格。支持txt(制表符分隔)文本文件<br>
        &nbsp;&nbsp;&nbsp;&nbsp;制图时将以第一列为x轴其他列为y轴数据。<br>
        <br>

        <h2>参数：<br></h2>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;① 自定义标题：可自己定义散点图的标题名称。<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;② X轴标题：可自己定义散点图的X轴标题名称。<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;③ Y轴标题：可自己定义散点图的Y轴标题名称。<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;④ 自定义气泡的颜色：可自己定义气泡图的颜色，注意颜色数量要与系列数相等，不设置则系统默认颜色<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;⑤散点大小：可自定义散点的大小，默认为。2<br>
        <br>

        <h2>输出：<br></h2>
        &nbsp;&nbsp;&nbsp;&nbsp;程序将输出散点图，提供SVG格式的图片下载<br>
      </div>
    </div>
    <div id="line">
      <h2>生成结果</h2>
...
export default {
  ...
  methods: {
    file1(){
      ...
      window.open(this.Host.BASE_URL + 'public/BaseFunction/scatterplot/sandian.txt','_blank')
    },
    ...
    output(type) {
      ...
      if(this.chartInstance){
        ...
        let _this = this
        _this.$axios({
          url: this.Host.BASE_URL + 'BaseFunction/scatterplot/multiUpload',
          method: 'post',
          data: _this.formData,
          headers: {
          ...
          if(res.data==='token过期'){
            ...
            // console.log(fd)
            _this.$axios({
              url: this.Host.BASE_URL + 'BaseFunction/scatterplot/save',
              method: 'post',
              data:
              fd,
              //_this.para,
