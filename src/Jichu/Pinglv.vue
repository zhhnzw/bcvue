...
<!--          </el-form-item>-->
      ...
      <div id="rightbox">
        <h2>功能：<br></h2>
        &nbsp;&nbsp;&nbsp;&nbsp;用一个以tab符分隔的带表头的表格数据绘制一个动态的频率直方图。<br>
        <br>

        <h2>输入：<br></h2>
        &nbsp;&nbsp;&nbsp;&nbsp;支持txt(制表符分隔)文本文件，csv(逗号分隔)文本文件。第一行为表头，其他行为数据，共一列。<br>
        &nbsp;&nbsp;&nbsp;&nbsp;最后一行必须回车。<br>
        <br>

        <h2>参数：<br></h2>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.自定义标题：可自己定义频率直方图的标题名称(必选)<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. X轴标题：可自己定义频率直方图的X轴标题名称（可选）<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. Y轴标题：可自己定义频率直方图的Y轴标题名称（可选）<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4.频率直方图主题：有如下主题可供选择“macarons”, “infographic”, “blue”, “dark”, “gray”, “green”,“shine”,“helianthus”, “macarons2”, “mint”, “red”, “roma”, “sakura”,  “vintage”（可选）<br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5.显示类型：type1表示频率直方图，type2表示密度直方图<br>
        <br>
...
export default {
  ...
  methods: {
    file1(){
      ...
      window.open(this.Host.BASE_URL + 'public/BaseFunction/freqhistogram/bar.txt','_blank')
    },
